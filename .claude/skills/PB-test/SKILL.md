...
All Playwright-related skills in this phase live under **`PB-test/`**, keeping Phase B testing capabilities grouped in one location.
...
Full paths use the `.claude/skills/PB-test/` base, for example:
