...
- `.claude/skills/PB-test/playwright-pom/SKILL.md` — POM structure all generated code follows
- `.claude/skills/PB-test/playwright-test-lifecycle/SKILL.md` — plan / generate / heal lifecycle
- `.claude/skills/PB-test/playwright-test-gen/SKILL.md` — full orchestration workflow
