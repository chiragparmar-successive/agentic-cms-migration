...
Generate all pages, layouts, and components for the Next.js 15 App Router project, wired to the CMS adapter.
...
- Vercel skill packs (quality guardrails):
  ...
  - `.claude/skills/PD-frontend/vercel/next-cache-components/SKILL.md`
...
If neither preferred nor fallback design references exist, STOP and run Phase B exploratory crawl first (see `.claude/commands/PB-test.md`).
